 ...
 */ (function(n, t) {
    ...
    function u(n) {
        return function() {
            ...
            var e = t.length;
            for(var r = 0; r < e; r++){
                if (!n.call(null, t[r])) return false;
            }
            return true;
        };
    }
    function o(n) {
        return function() {
            ...
            var e = t.length;
            for(var r = 0; r < e; r++){
                if (n.call(null, t[r])) return true;
            }
            return false;
        };
    }
    ...
    n.sameType = function(e, r) {
        var a = t.call(e);
        if (a !== t.call(r)) return false;
        if (a === "[object Number]") return !n.any.nan(e, r) || n.all.nan(e, r);
        return true;
    };
    n.sameType.api = [
        "not"
    ...
    n.empty = function(t) {
        if (n.object(t)) {
            ...
            if (e === 0 || e === 1 && n.array(t) || e === 2 && n.arguments(t)) return true;
            return false;
        }
        return t === "";
    };
    ...
    n.equal = function(t, e) {
        if (n.all.number(t, e)) return t === e && 1 / t === 1 / e;
        if (n.all.string(t, e) || n.all.regexp(t, e)) return "" + t === "" + e;
        if (n.all.boolean(t, e)) return t === e;
        return false;
    };
    n.equal.api = [
        "not"
    ...
    n.capitalized = function(t) {
        ...
        for(var r = 0; r < e.length; r++){
            ...
            if (a.length) {
                var u = a.charAt(0);
                if (u !== u.toUpperCase()) return false;
            }
        }
        return true;
    };
    ...
    n.palindrome = function(t) {
        ...
        for(var r = 0, a = Math.floor(e / 2); r <= a; r++){
            if (t.charAt(r) !== t.charAt(e - r)) return false;
        }
        return true;
    };
    n.space = function(t) {
        if (n.not.char(t)) return false;
    ...
    n.inDateRange = function(t, e, r) {
        if (n.not.date(t) || n.not.date(e) || n.not.date(r)) return false;
        var a = t.getTime();
    ...
    n.propertyCount = function(t, e) {
        if (n.not.object(t) || n.not.number(e)) return false;
        var a = 0;
        for(var u in t){
            if (r.call(t, u) && ++a > e) return false;
        }
        return a === e;
    };
    n.propertyCount.api = [
    ...
    n.propertyDefined.api = [
        "not"
    ];
    n.inArray = function(t, e) {
        if (n.not.array(e)) return false;
        for(var r = 0; r < e.length; r++){
    ...
    n.sorted = function(t, e) {
        if (n.not.array(t)) return false;
        var r = i[e] || i[">="];
        for(var a = 1; a < t.length; a++){
            if (!r(t[a], t[a - 1])) return false;
        }
        return true;
    };
    function j() {
        var t = n;
        for(var e in t)if (r.call(t, e) && n["function"](t[e])) {
            var i = t[e].api || [
                "not",
                "all",
                "any"
            ...
            for(var f = 0; f < i.length; f++){
                if (i[f] === "not") n.not[e] = a(n[e]);
                if (i[f] === "all") n.all[e] = u(n[e]);
                if (i[f] === "any") n.any[e] = o(n[e]);
            }
        }
    }
    j();
    ...
    n.setRegexp = function(n, t) {
        for(var e in l)if (r.call(l, e) && t === e) l[e] = n;
    };
    return n;
});

//# sourceMappingURL=index.8d32a759.js.map
